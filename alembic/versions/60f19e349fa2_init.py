...
Revision ID: 60f19e349fa2
Revises:
Create Date: 2025-04-04 23:56:50.933011
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_market_data_exchange"), "market_data", ["exchange"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "commission_asset", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
